...
// * @return *Position
// */
//func (a PositionApi) PositionTransferIsolatedMargin(symbol string, amount float32) (*bitmex.Position, *APIResponse, error) {
//
//	var httpMethod = "Post"
//	// create path and map variables
...
// * @return *Position
// */
//func (a PositionApi) PositionUpdateLeverage(symbol string, leverage float64) (*bitmex.Position, *APIResponse, error) {
//
//	var httpMethod = "Post"
//	// create path and map variables
